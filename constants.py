...
if getattr(sys, 'frozen', False):
    # 表示用 PyInstaller 打包後的執行狀態
    BASE_DIR = sys._MEIPASS
else:
    # 在開發環境或直接 python main.py 時
    BASE_DIR = os.path.dirname(__file__)

LETTER_FORMAT_PATH = os.path.join(BASE_DIR, 'res', 'tw_lal.pdf')
DEFAULT_FONT_PATH  = os.path.join(BASE_DIR, 'res', 'TW-Kai-98_1.ttf')
